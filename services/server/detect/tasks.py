...
@shared_task
def check_process(date, host, image, command_line, parent_image, parent_command_line, original_file_name, process_user) -> None:
    field_names = {'ParentCommandLine':parent_command_line, 'ParentImage':parent_image, 'Image':image, 'CommandLine':command_line, 
        'OriginalFileName':original_file_name,'User':process_user}
